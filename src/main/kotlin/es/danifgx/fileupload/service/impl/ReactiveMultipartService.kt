...
@ApplicationScoped
class ReactiveMultipartService : FileUploadService {
    ...
    @ConfigProperty(name = "file.upload.directory.reactive", defaultValue = "uploads/reactive")
    ...
    fun init() {
        ...
        logger.info("ReactiveMultipartService inicializado. Directorio: $uploadDirectory")
    }
    
    override val strategyName: String = "reactive-multipart"
    
    override val strategyDescription: String = "Estrategia de carga con multipart/form-data usando RESTEasy Reactive"
    
    override val serverImplementation: String = "RESTEasy Reactive (Netty)"
    ...
    override fun uploadFile(fileName: String, fileContent: InputStream, fileSize: Long): UploadResult {
        ...
        try {
            ...
            logger.info("Archivo $actualFileName subido con éxito usando Reactive. Tamaño: $fileSize bytes, Tiempo: $uploadTime ms")
            ...
            logger.error("Error al subir archivo con Reactive: ${e.message}", e)
